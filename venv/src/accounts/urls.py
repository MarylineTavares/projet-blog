...
from accounts.views import account, create_account, logout_user, profile, set_default_shipping, delete_address
app_name = "accounts"
...
urlpatterns = [
    ...
    path('profile/set-default-shipping/<int:pk>', set_default_shipping, name='set_default_shipping'),
